...
IkaTools = (function() {
  ...
  var EmpireData = function() {
    ...
    function processCityMilitaryView(data) {
      ...
      var e = false;
      e |= military._updatePresent(Constants.Military.HOPLITE, parseInt(armyTds[1].innerHTML));
      e |= military._updatePresent(Constants.Military.STEAM_GIANT, parseInt(armyTds[2].innerHTML));
      e |= military._updatePresent(Constants.Military.SPEARMAN, parseInt(armyTds[3].innerHTML));
      e |= military._updatePresent(Constants.Military.SWORDSMAN, parseInt(armyTds[4].innerHTML));
      e |= military._updatePresent(Constants.Military.SLINGER, parseInt(armyTds[5].innerHTML));
      e |= military._updatePresent(Constants.Military.ARCHER, parseInt(armyTds[6].innerHTML));
      e |= military._updatePresent(Constants.Military.GUNNER, parseInt(armyTds[7].innerHTML));
      e |= military._updatePresent(Constants.Military.BATTERING_RAM, parseInt(armyTds[8].innerHTML));
      e |= military._updatePresent(Constants.Military.CATAPULT, parseInt(armyTds[9].innerHTML));
      e |= military._updatePresent(Constants.Military.MORTAR, parseInt(armyTds[10].innerHTML));
      e |= military._updatePresent(Constants.Military.GYROCOPTER, parseInt(armyTds[11].innerHTML));
      e |= military._updatePresent(Constants.Military.BALLOON_BOMBADIER, parseInt(armyTds[12].innerHTML));
      e |= military._updatePresent(Constants.Military.COOK, parseInt(armyTds[13].innerHTML));
      ...
      e |= military._updatePresent(Constants.Military.PADDLE_SPEED_SHIP, parseInt(navyTds[11].innerHTML));
      e |= military._updatePresent(Constants.Military.BALLOON_CARRIER, parseInt(navyTds[10].innerHTML));
      e |= military._updatePresent(Constants.Military.TENDER, parseInt(navyTds[9].innerHTML));
