...
namespace TwistedFateTexasHoldEm
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Make the menu
            Config = new Menu("Twisted Fate", "TwistedFateTHEm", true);
            ...
            w.AddItem(
                new MenuItem("SelectYellow", "Select Yellow").SetValue(new KeyBind("Z".ToCharArray()[0],
                    KeyBindType.Press)));
            w.AddItem(
                new MenuItem("SelectBlue", "Select Blue").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
            w.AddItem(
                new MenuItem("SelectRed", "Select Red").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
            Config.AddSubMenu(w);
